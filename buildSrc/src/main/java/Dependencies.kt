...
object Versions {
    ...
    const val loging = "5.0.0-alpha.2"
    ...
    const val daggerAndroid = "2.40"
    const val daggerAndroidSupport = "2.40"
    const val daggerKapt = "2.40"
    const val daggerKaptAndroid = "2.40"
    const val koin = "3.1.3"
    const val koinAndroid = "3.1.3"
    const val koinAndroidCompat = "3.1.3"
    const val coroutine = "1.5.2-native-mt"
    const val coroutineAndroid = "1.5.2-native-mt"
